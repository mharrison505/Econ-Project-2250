...
### --- Wins column ---
wins <- df$W   # adjust if your column is not named exactly "W"
...
ggplot(df, aes(x = PYds, y = W)) +
  geom_point(size = 3) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
    title = "Wins vs PYds",
    subtitle = paste("r =", round(r_value, 4), "   r² =", round(r_sq, 4)),
    x = "Passing Yards (PYds)",
    y = "Wins"
  ) +
  theme_minimal()
...
ggplot(df, aes(x = RYds, y = W)) +
  geom_point(size = 3) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
    title = "Wins vs RYds",
    subtitle = paste("r =", round(r_value, 4), "   r² =", round(r_sq, 4)),
    x = "Rushing Yards (RYds)",
    y = "Wins"
  ) +
  theme_minimal()
...
ggplot(df, aes(x = PtsA, y = W)) +
  geom_point(size = 3) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
    title = "Wins vs PtsA",
    subtitle = paste("r =", round(r_value, 4), "   r² =", round(r_sq, 4)),
    x = "Points Allowed (PtsA)",
    y = "Wins"
  ) +
  theme_minimal()
...
ggplot(df, aes(x = PYdsA, y = W)) +
  geom_point(size = 3) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
    title = "Wins vs PYdsA",
    subtitle = paste("r =", round(r_value, 4), "   r² =", round(r_sq, 4)),
    x = "Passing Yards Allowed (PYdsA)",
    y = "Wins"
  ) +
  theme_minimal()
...
ggplot(df, aes(x = RYdsA, y = W)) +
  geom_point(size = 3) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
    title = "Wins vs RYdsA",
    subtitle = paste("r =", round(r_value, 4), "   r² =", round(r_sq, 4)),
    x = "Rushing Yards Allowed (RYdsA)",
    y = "Wins"
  ) +
  theme_minimal()
