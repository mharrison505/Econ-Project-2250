...
>>>>>>> a6ef9d07fd4137a7b3caee110c038b15131c51e6
```
...
p_value1 <- summary(model)$coefficients[2, 4]
...
p_value6 <- summary(model6)$coefficients[2, 4]
...
nfl_data <- read_excel("ALLSTATS2024.xlsx")
...
```
>>>>>>> 87c34df20024d065a638111427352d86908fbac2
