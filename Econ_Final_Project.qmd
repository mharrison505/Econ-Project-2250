...
ggplot(NFL_Stats, aes(x = PA, y = `Takeaways(Defense)`, label = '')) +
  ...
  geom_text_repel(size = 3) +
  geom_smooth(method = "lm", color = "green", se = FALSE) +
  labs(x = "Points Allowed", y = "Takeaways", title = "NFL Points Allowed vs Passing Yards Allowed") +
  annotate("text",
           x = max(NFL_Stats$PA),
...
ggplot(NFL_Stats, aes(x = `Pts For`, y = `RY/G`, label = '')) +
  ...
  geom_text_repel(size = 3) +
  geom_smooth(method = "lm", color = "green", se = FALSE) +
  labs(x = "Points Scored", y = "Takeaways", title = "NFL Points Scored vs Rushing Yards") +
  annotate("text",
...
ggplot(NFL_Stats, aes(x = `Pts For`, y = `PY/G`, label = '')) +
  ...
  geom_text_repel(size = 3) +
  geom_smooth(method = "lm", color = "green", se = FALSE) +
  labs(x = "Points Scored", y = "Takeaways", title = "NFL Points Scored vs Passing Yards") +
  annotate("text",
           x = max(NFL_Stats$`Pts For`),
...
ggplot(NFL_Stats, aes(x = `Pts For`, y = `TO Lost (Offense)`, label = '')) +
  ...
  geom_text_repel(size = 3) +
  geom_smooth(method = "lm", color = "green", se = FALSE) +
  labs(x = "Points Scored", y = "Takeaways", title = "NFL Points Scored vs Turnovers Lost") +
  annotate("text",
           x = max(NFL_Stats$`Pts For`),
